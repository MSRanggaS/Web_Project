<?php
  session_start(); 
  include 'conn.php';
  $pitakonan = "SELECT * FROM daftar_pertanyaan WHERE `mata_pelajaran`='PPKN' ORDER BY tgl_post DESC";
  $wangsulan = "SELECT * FROM daftar_jawaban";
  $materi = "SELECT * FROM daftar_materi WHERE `mata_pelajaran`='PPKN' ORDER BY tgl_post DESC";
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">PPKN</h1>
          </div>
          ...
          <?php foreach($rows as $row) :?> 
              ...
              <div class="card shadow mb-4 mx-1" id="header<?= $j ?>">
                ...
                <div class="card-body">
                  ...
                  <hr class="divider">
                  <form class="form-group row" style="margin-bottom: 0px;" action="<?php echo 'PPKN.php?idPertanyaan='.$row['id_pertanyaan'];?>#header<?= $j ?>" method="post">
