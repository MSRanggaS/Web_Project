      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4 mx-1">
                ...
                <form class="user m-2 p-2" action="home_murid.php" method="post">
                    <div class="form-group row" style="margin-bottom: 0px;">
                      <div class="form-group mx-3">
                        <select class="custom-select my-1 mr-sm-2" id="mapel" name="mapel" required>
                      ...
                      <div class="form-check mx-3 py-2">
                        <input class="form-check-input" type="checkbox" id="urgent" name="urgent" value="">
                        <label class="form-check-label" for="urgent" style="font-size:20px;">    Urgent</label>
                      </div>
                    </div>
                    <div class="form-group row" style="margin-bottom: 0px;">
                      <div class="col-lg-10 col-sm-8 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" id="pertanyaan" name="pertanyaan" placeholder="Ajukan Pertanyaan..." required>
                      </div>
                      <div class="col-lg-2 col-sm-4">
                        <button type="submit" name="submit" class="btn btn-success btn-user btn-block">
                          <h5 style="margin-bottom: 0px;">Tanya!</h5>
                        </button>
                      </div>
                    </div>
                </form>
          ...
          <?php foreach($rows as $row) :?> 
              ...
              <div class="card shadow mb-4 mx-1" id="header<?= $j ?>">
                ...
                <div class="card-body">
                  ...
                  <hr class="divider">
                  <form class="form-group row" style="margin-bottom: 0px;" action="<?php echo 'home_murid.php?idPertanyaan='.$row['id_pertanyaan'];?>#header<?= $j ?>" method="post">
