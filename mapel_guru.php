          ...
          <div>
            <div class="row">
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="PPKN.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">PPKN</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="BahasaIndonesia.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Bahasa Indonesia</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="BahasaInggris.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Bahasa Inggris</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="Matematika.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Matematika</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="Biologi.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Biologi</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="Fisika.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Fisika</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="Kimia.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Kimia</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="Sejarah.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Sejarah</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="Geografi.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Geografi</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <a href="Ekonomi.php" target="blank" class="h5 mb-0 font-weight-bold text-gray-800">Ekonomi</a>
                  </div>
                </div>
              </div>
