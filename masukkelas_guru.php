<?php
    ...
    if(isset($_POST['buat'])){
      ...
      if(mysqli_query($conn,$sql)){
        header("Location: masukkelas_guru.php");
      }else{
      echo "Gagal Entri";
      }
    }
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4 ">
            <div class="mx-2">
                ...
                <form class="user m-2 p-2"action="masukkelas_guru.php" method="post">
            ...
            <table class="table table-striped mt-3">
                ...
                <?php foreach($rows as $row) : ?>
                    <tr>
                        ...
                        <td> <form action="<?php echo 'masukkelas_guru.php?kelas='.$row['namakelas'];?>" method="post">
                            <?php $flag = 0; ?>
                        ...
                        <td> 
                          <?php $a=$row['namakelas']; ?>
                          <a class="btn btn-success btn-user" href='kelas_guru.php?namakelas=<?= $row['namakelas']; ?>'>Detail</a>
