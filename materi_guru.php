<?php
  session_start(); 
  include 'conn.php';
  $pitakonan = "SELECT * FROM daftar_materi ORDER BY tgl_post DESC";
  $date = "SELECT tgl_post FROM daftar_materi";
  ...
  if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO daftar_materi (`mata_pelajaran`,`materi`,`pemateri`)
    VALUES ('$mapel','$materi','$pemateri')";
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4 mx-1">
                ...
                <form class="user m-2 p-2" action="materi_guru.php" method="post">
                    <div class="form-group row" style="margin-bottom: 0px;">
                      <div class="form-group mx-3">
                        <select class="custom-select my-1 mr-sm-2" id="mapel" name="mapel">
                    ...
                    <div class="form-group row" style="margin-bottom: 0px;">
                      <div class="col-lg-10 col-sm-8 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" id="materi" name="materi" placeholder="Ajukan Materi">
                      </div>
                      <div class="col-lg-2 col-sm-4">
                        <button type="submit" name="submit" class="btn btn-success btn-user btn-block">
                          <h5 style="margin-bottom: 0px;">Ajukan</h5>
                        </button>
                      </div>
                    </div>
                </form>
          ...
          <?php foreach($rows as $row) :?> 
              ...
              <div class="card shadow mb-4 mx-1">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-success"> <?=  $row['pemateri'] ?> </h6>
                ...
                <div class="card-body">
                 ...
                 <p class="h5 mt-3 font-weight-bold text-gray-800"> <?=  $row['materi'] ?> </p>
                </div>
              </div>
