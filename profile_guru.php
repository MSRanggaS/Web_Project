<?php
  ...
  $kelas = "SELECT * FROM kelas WHERE `user` = '$orang'";

  $rows = mysqli_query($conn, $kelas);
  $i = 0;
  mysqli_close($conn);
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="container mt-2">
              <img src="images/pp" style="border-radius:5%;width:175px;" alt="Profile Picture">
              <h5 class="mt-5">Email :
                  <?= $_SESSION['email'] ?>
              </h5>
              <h5 class="mt-5">Nama :
              ...
              <h5 class="mt-5">Kelas yang terdaftar :
